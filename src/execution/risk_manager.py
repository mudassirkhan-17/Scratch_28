...
from validation import validate_stop_loss_take_profit
...
class RiskManager:
    ...
    def __init__(self, sl_tp_config):
        ...
        sl_value = sl_tp_config.get('stop_loss_percentage', 2.0)
        tp_value = sl_tp_config.get('take_profit_percentage', 4.0)
        self.stop_loss_percentage, self.take_profit_percentage = validate_stop_loss_take_profit(
            sl_value, tp_value, "Stop Loss/Take Profit"
        )
